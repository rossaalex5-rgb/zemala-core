...
print("[ZEMALA Master-Daemon] Vollständige Kaskade inklusive Auditor aktiv. Drücke Ctrl+C zum Stoppen.")
while True:
    try:
        ...
        print(f"[ZEMALA Master-Daemon] Voller Takt, Audit & Sync vollzogen: {datetime.utcnow().isoformat()}Z")
        time.sleep(60)

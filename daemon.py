...
print("[ZEMALA Master-Daemon] Vollständige Kaskade inklusive Telemetrie aktiv. Drücke Ctrl+C zum Stoppen.")
while True:
    try:
        ...
        print(f"[ZEMALA Master-Daemon] Voller Takt & Telemetrie vollzogen: {datetime.utcnow().isoformat()}Z")
        time.sleep(60)

...
print("[ZEMALA Master-Daemon] Kaskade mit Geometrie-Matrix aktiv. Drücke Ctrl+C zum Stoppen.")
while True:
    try:
        ...
        print(f"[ZEMALA Master-Daemon] Voller Takt & Matrix vollzogen: {datetime.utcnow().isoformat()}Z")
        time.sleep(60)
